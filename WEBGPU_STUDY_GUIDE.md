...
- **Adjacent guides in this repo:** [WebGL/OpenGL](WEBGL_OPENGL_STUDY_GUIDE.md) (the predecessor model — read first if you haven't), [GPU Programming with CUDA](CUDA_STUDY_GUIDE.md) (the native NVIDIA stack — same throughput machine, without the portability constraints), [Advanced Rust](ADVANCED_RUST_STUDY_GUIDE.md) (the wgpu path), and [LLM App Development](LLM_APP_DEV_STUDY_GUIDE.md) (where browser GPU inference shows up).
