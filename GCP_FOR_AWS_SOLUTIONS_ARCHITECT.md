...
- **Adjacent guides in this repo:** [AWS Fundamentals](AWS_FUNDAMENTALS_STUDY_GUIDE.md) (the AWS side of every mapping here), [Azure for AWS architects](AZURE_FOR_AWS_SOLUTIONS_ARCHITECT.md), [Terraform](TERRAFORM_STUDY_GUIDE.md), [Kubernetes](k8s/KUBERNETES_STUDY_GUIDE.md) (GKE is the managed-K8s reference implementation), and [Data Engineering](DATA_ENGINEERING_STUDY_GUIDE.md) (BigQuery's world).
