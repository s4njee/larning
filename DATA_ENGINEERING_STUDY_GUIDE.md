...
**Adjacent guides in this repo:** [Kafka & Stream Processing](KAFKA_STUDY_GUIDE.md) (the broker itself, at full depth), [Distributed Systems](DISTRIBUTED_SYSTEMS_STUDY_GUIDE.md) (Kafka/partitioning theory under everything here), [Database Internals](DATABASE_INTERNALS_STUDY_GUIDE.md) (the engines), [Advanced Postgres](ADVANCED_POSTGRES.md), and [Observability](OBSERVABILITY_STUDY_GUIDE.md) (pipeline health).
