...
An image is an ordered collection of filesystem layers plus metadata (environment variables, entrypoint, exposed ports, labels). Each layer is a tar archive of filesystem changes.
