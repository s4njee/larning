...
- **Adjacent guides in this repo:** the [Kafka & Stream Processing](KAFKA_STUDY_GUIDE.md) (Part 8's log, at full depth), [Durable Execution](DURABLE_EXECUTION_STUDY_GUIDE.md) (Part 7's sagas given a runtime), [Redis](REDIS_STUDY_GUIDE.md), [Data Engineering](DATA_ENGINEERING_STUDY_GUIDE.md), [Observability](OBSERVABILITY_STUDY_GUIDE.md), [Kubernetes](k8s/KUBERNETES_STUDY_GUIDE.md), [Postgres](POSTGRES.md), and [Networking Fundamentals](NETWORKING_FUNDAMENTALS.md) guides each go deeper on a slice of this picture.
