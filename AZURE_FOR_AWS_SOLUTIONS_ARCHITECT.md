...
- **Adjacent guides in this repo:** [AWS Fundamentals](AWS_FUNDAMENTALS_STUDY_GUIDE.md) (the AWS side of every mapping here), [GCP for AWS architects](GCP_FOR_AWS_SOLUTIONS_ARCHITECT.md) (the third cloud, same method), [Terraform](TERRAFORM_STUDY_GUIDE.md) (declaring all of it), and [Kubernetes](k8s/KUBERNETES_STUDY_GUIDE.md) (AKS's substrate).
