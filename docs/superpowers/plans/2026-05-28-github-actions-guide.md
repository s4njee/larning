...
- [ ] **Step 1: Create the file with title, intro, and full Table of Contents**
...
- [ ] **Step 2: Write Part 1 subsections**
...
- [ ] **Step 3: Write the "first workflow, dissected" example**
...
- [ ] **Step 1: Triggers & events subsection**
...
- [ ] **Step 2: Jobs, steps, runners, the DAG subsection**
...
- [ ] **Step 3: Contexts & expressions subsection**
...
- [ ] **Step 4: Env, defaults, shells subsection**
...
- [ ] **Step 1: setup-* across ecosystems subsection (pattern-first, multi-stack)**
...
- [ ] **Step 3: Matrix builds subsection**
...
- [ ] **Step 4: Artifacts & inter-job data subsection**
...
- [ ] **Step 5: Service containers subsection**
...
- [ ] **Step 1: Reusable workflows subsection**
...
- [ ] **Step 2: Composite actions subsection**
...
- [ ] **Step 3: Org-level reuse subsection**
...
- [ ] **Step 4: Decision guide subsection**
...
- [ ] **Step 1: The three kinds subsection**
...
- [ ] **Step 4: Worked Docker-container action**
...
- [ ] **Step 5: Versioning & distribution subsection**
...
- [ ] **Step 1: Environments subsection**
...
- [ ] **Step 2: Secrets & variables subsection**
...
- [ ] **Step 3: OIDC to cloud (in depth) — AWS worked example**
...
- [ ] **Step 4: Deploy patterns subsection**
...
- [ ] **Step 5: Release & publishing automation subsection**
...
- [ ] **Step 1: Threat model subsection**
...
- [ ] **Step 2: pull_request vs pull_request_target subsection**
...
- [ ] **Step 3: Script injection subsection**
...
- [ ] **Step 4: Pinning third-party actions subsection**
...
- [ ] **Step 5: Least privilege subsection**
...
- [ ] **Step 6: Secrets exposure & supply chain subsection**
...
- [ ] **Step 3: Autoscaling with ARC subsection**
...
- [ ] **Step 5: Cost & optimization subsection**
...
- [ ] **Step 2: Migration & "when not to use Actions" subsection**
...
- [ ] **Step 1: Five recipes subsection**
...
- [ ] **Step 2: End-to-end walkthrough subsection**
...
- [ ] **Step 2: Extract complete workflow examples and lint them**
