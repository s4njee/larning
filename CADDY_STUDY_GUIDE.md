...
Automatic HTTPS is Caddy's signature feature. Understanding how it works — and when to override it — is essential for running Caddy in production.
...
The reverse proxy is Caddy's most-used directive. It handles upstream selection, load balancing, health checks, header manipulation, retries, and transport configuration.
